...
pub fn create_builtin_registry() -> HashMap<String, JsonFunction> {
    ...
    registry.insert(
        ...
        JsonFunction::new(Arc::new(BuiltinCallable::sync_fn(Some(2), |args| {
            strings::substring_before(&args[0], &args[1])
        }))),
    );
    ...
    registry.insert(
        ...
        JsonFunction::new(Arc::new(BuiltinCallable::sync_fn(Some(2), |args| {
            strings::substring_after(&args[0], &args[1])
        }))),
    );
